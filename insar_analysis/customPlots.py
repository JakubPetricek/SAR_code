...
def plotdata(GDALfilename, band=1,
    ...
    if draw_colorbar is not None:
        cbar = fig.colorbar(cax,orientation=colorbar_orientation, fraction=0.03, pad=0.06)
...
def plotcomplexdata(GDALfilename,
    ...
    if draw_colorbar is not None:
        cbar1 = fig.colorbar(cax1,orientation=colorbar_orientation, fraction=0.03, pad=0.06)
    ax.set_aspect(aspect)
    ...
    if draw_colorbar is not None:
        cbar2 = fig.colorbar(cax2, orientation=colorbar_orientation, fraction=0.03, pad=0.06)
    ax.set_aspect(aspect)
    plt.show()
...
def plotstackdata(GDALfilename_wildcard, band=1,
    ...
    ax.set_title(title)
    if draw_colorbar is not None:
        cbar = fig.colorbar(cax,orientation=colorbar_orientation, fraction=0.046, pad=0.04)
    ax.set_aspect(aspect)    
    plt.show() 
...
def plotstackcomplexdata(GDALfilename_wildcard,
    ...
    ax.set_title(title + " (amplitude)")
    if draw_colorbar is not None:
        cbar1 = fig.colorbar(cax1,orientation=colorbar_orientation, fraction=0.046, pad=0.04)
    ax.set_aspect(aspect)
    ...
    ax.set_title(title + " (phase [rad])")
    if draw_colorbar is not None:
        cbar2 = fig.colorbar(cax2,orientation=colorbar_orientation, fraction=0.046, pad=0.04)
    ax.set_aspect(aspect)
    plt.show() 
